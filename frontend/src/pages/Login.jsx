                ...
                <div className='p-8'>
                    ...
                    <form className='mt-6 space-y-5' onSubmit={handleSubmit}>
                        ...
                        <button
                            type='submit'
                            disabled={loading}
                            className='w-full rounded-xl bg-gradient-to-r from-sky-600 to-blue-700 px-4 py-3 text-white font-semibold shadow-lg hover:from-sky-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-sky-400/50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 cursor-pointer'
                        >
