...
export default function Login() {
    ...
    return (
        <div className={clsx('min-h-dvh', 'flex')} style={{ backgroundColor: '#ffffff' }}>
            {/* Left panel */}
            <div className={clsx('hidden', 'lg:flex', 'lg:w-1/2', 'flex-col', 'justify-between', 'p-12')} style={{ backgroundColor: '#111111' }}>
                ...
                <div className="space-y-1" style={{ fontFamily: 'var(--font-mono)' }}>
                    <p className={clsx('text-xs', 'text-[#444]')}>FEV-RIPS · v0.1.0</p>
                    <p className={clsx('text-xs', 'text-[#444]')}>Version API MINISTERIO DE SALUD· v1.4.11.0 11/08/2026</p>
                </div>
            </div>
